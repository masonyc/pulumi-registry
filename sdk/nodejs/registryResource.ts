...
export class RegistryResource extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegistryResourceState, opts?: pulumi.CustomResourceOptions): RegistryResource {
        return new RegistryResource(name, <any>state, { ...opts, id: id });
    }
     ...
     */
    public static isInstance(obj: any): obj is RegistryResource {
    ...
    constructor(name: string, argsOrState?: RegistryResourceArgs | RegistryResourceState, opts?: pulumi.CustomResourceOptions) {
        ...
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as RegistryResourceState | undefined;
        ...
        super(RegistryResource.__pulumiType, name, resourceInputs, opts);
    }
}
